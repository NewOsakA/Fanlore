...
urlpatterns = [
    ...
    # Friend
    path('friends/', views.friend.FriendListView.as_view(),
         name="friends-list"),
    path("friends/add/<int:user_id>/",
         views.friend.FriendRequestCreateView.as_view(),
         name="add-friend"),
    path("friends/accept/<int:pk>/",
         views.friend.FriendRequestAcceptView.as_view(),
         name="accept-friend"),
    path("friends/reject/<int:pk>/",
         views.friend.FriendRequestRejectView.as_view(),
         name="reject-friend"),
    path("friends/remove/<int:user_id>/",
         views.friend.RemoveFriendView.as_view(),
         name="remove-friend"),
    ...
    path('content_edit/<uuid:pk>/', views.ContentUpdateView.as_view(),
         name='content_edit'),
    path('upload/', views.ContentUploadView.as_view(),
         name='upload_content'),
    path("content/<uuid:content_id>/add_release/",
         views.ReleaseCreateView.as_view(),
         name="add_release"),
    path('release/<uuid:release_id>/delete/',
    ...
    path("event/<int:event_id>/submit/", views.event.EventSubmitView.as_view(),
         name="event-submit"),
    path("events/", views.event.EventListView.as_view(),
         name="event-list"),
    ...
    path("category/<str:category_id>/",
         views.CategoryContentListView.as_view(),
         name="category-posts"),
    path('api/check-tags/', views.check_tag_existence,
         name='check-tags'),
    ...
    path('report/<uuid:pk>/', views.ReportContentView.as_view(),
         name='report-content'),
    path('user/<int:user_id>/follow/',
         views.profile.FollowUserView.as_view(),
         name='follow-user'),
    path('user/<int:user_id>/unfollow/',
         views.profile.UnfollowUserView.as_view(),
         name='unfollow-user'),
]
